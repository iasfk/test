...
public class BoardRestController {
	...
	@PostMapping("/getget")
	public ResponseEntity<Board> getBoard(int id){
		return new ResponseEntity<Board>(boardService.getBoardByNum(id), HttpStatus.CREATED);
	}
	...
	public ResponseEntity<Board> detail(@PathVariable int id) {
		try {
			...
			throw new BoardNotFoundException(id +"번 게시글은 없습니다.");		
		}
	}
